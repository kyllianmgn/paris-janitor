import { ApiResponse, Payment, PaymentStatus, ServicePayment } from "@/types";
import { api } from "@/api/config";

export const paymentService = {
    createPayment: async (paymentData: Omit<Payment, "id" | "status" | "stripePaymentIntentId">): Promise<ApiResponse<Payment & { sessionUrl: string }>> => {
